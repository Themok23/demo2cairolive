      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-card bg-surface shadow-card p-8">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-button border border-muted py-3 px-4 text-sm font-semibold text-text-primary hover:bg-muted/50 transition-colors"
          >
